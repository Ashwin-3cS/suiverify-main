    ...
    case 'IN':
      return [
        ...
        },
        {
          ...
          description: 'Government-consent flow via DigiLocker — PAN today, Aadhaar and more coming',
          icon: <CreditCard className="w-6 h-6" />,
          features: ['Consent-based retrieval', 'No manual upload', 'Signed government source'],
          available: true
        },
        {
          id: 'aadhaar',
